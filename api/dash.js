...
'<tfoot><tr><td></td><td>Total (office)</td><td class="num muted">&mdash;</td><td class="num">'+(ca.total!=null?ca.total:tC)+'</td><td class="num">'+fmt(rev.company.approved_amount)+'</td><td class="num">'+fmt(rev.company.contract_amount)+'</td></tr></tfoot></table>';
